...
ZERO_SHOT_COT_INSTRUCTION = IO_CODE_GEN_INSTRUCTION + " Think step by step by providing comments before each line of code."

ZERO_SHOT_COT_PLACEHOLDER = "{function_signature}"

SCOT_CODE_GEN_INSTRUCTION = IO_CODE_GEN_INSTRUCTION
...
SYNTH_FEW_SHOT_GEN_INSTRUCTION = "Your goal is to write Python3 code to solve competitive programming problems. Given a problem, explain the core concepts in it and provide three other relevant problems. Then solve the original problem. Use json format for your response."
...
SYNTH_FEW_SHOT_GEN_INSTRUCTION_POST = "Solve the coding task. Respond with python code only, not english. Restate the function signature. Besides the task, you will be given the core concepts in it and three other relevant problems as few-shots that could help you solve the task."

SYNTH_FEW_SHOT_GEN_FEW_SHOT_POST = '''
{preprocessed_prompt}
[function_description]:
{function_description}
[code_solution]:
...
AC_CODE_GEN_INSTRUCTION = "You are a Python programming assistant that can answer with json format only. For the key 'code_solution', provide one single solution to the problem."

AC_CODE_GEN_FEW_SHOT = '''
    ...
    {{
      "understand_and_clarify": {{
        ...
        "solution": "The length of a string is the number of characters it contains.",
