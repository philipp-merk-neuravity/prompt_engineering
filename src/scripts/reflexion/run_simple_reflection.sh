...
python3 "/home/neuravity/dev/prompt_engineering/src/simple_reflection.py" \
  ...
  --benchmark_type "all" \
  --chunk_size "57" \
  --tests_path "/home/neuravity/dev/prompt_engineering/src/benchmark_results/test_cases/0.2/codeT/gpt-3.5-turbo-0125/without_refinement/0/0.jsonl" \
