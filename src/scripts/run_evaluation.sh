...
BENCHMARK_RESULTS="/home/neuravity/dev/prompt_engineering/src/benchmark_results/all/simple/0.2/io/gpt-3.5-turbo-0125/combined_results.jsonl"
...
python3 "$PYTHON_SCRIPT" "$BENCHMARK_RESULTS" --problem_file="$PROBLEM_FILE" --k="6"
deactivate