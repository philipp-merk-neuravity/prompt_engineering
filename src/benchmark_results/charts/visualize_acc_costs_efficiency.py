...
save_path = "/home/neuravity/dev/prompt_engineering/src/benchmark_results/charts/img/simple_0.2"

# Load data from a JSON file
file_path = '/home/neuravity/dev/prompt_engineering/src/benchmark_results/charts/data/eval_prompt_method/0.2/normalized_data_with_utility.json'
...
for category, data_points in categories.items():
    ...
    utility_scores = [d["utility_score"] for d in data_points]
