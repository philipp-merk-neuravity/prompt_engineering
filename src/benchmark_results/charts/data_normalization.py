...
data_path = "/home/neuravity/dev/prompt_engineering/src/benchmark_results/charts/data/eval_prompt_method/0.2/gpt_3.5/combined_results_for_gpt4.json"
...
# Function to calculate utility based on normalized accuracy and cost
...
for method_name, method in data.items():
    ...
    for entry in method:
        ...
        utility_score = run_utility_analysis(normalized_accuracy, normalized_cost)
...
with open("/home/neuravity/dev/prompt_engineering/src/benchmark_results/charts/data/eval_prompt_method/0.2/normalized_data_with_utility_gpt4.json", 'w') as file:
