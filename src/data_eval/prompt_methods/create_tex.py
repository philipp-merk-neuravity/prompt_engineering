...
path = f"{DEV_PATH}/src/benchmark_results/results/data/eval_prompt_method/combined_results.jsonl"
save_path = f"{DEV_PATH}/src/benchmark_results/results/data/eval_prompt_method"
