...
path = f"{DEV_PATH}/src/benchmark_results/results/data/eval_prompt_method_gen_tests/combined_samples.jsonl"
save_path = f"{DEV_PATH}/src/benchmark_results/images/sampling_gen_tests"
